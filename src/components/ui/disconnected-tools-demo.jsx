...
export function DisconnectedToolsDemo({ className }) {
...
const Icons = {
    ...
    >
      <defs>
        <radialGradient
          ...
          id="canva-gradient"
        >
          <stop stopColor="#7D2AE7" offset="0%" />
          <stop stopColor="#00C4CC" offset="100%" />
        </radialGradient>
      </defs>
      <circle cx="128" cy="128" r="128" fill="url(#canva-gradient)" />
      <path
        d="M165.5 139.5c-3.5 8.5-10 15.5-18 19.5-8.5 4.5-18.5 5.5-28 3-9-2-16.5-7.5-21.5-15-5-7.5-7-16.5-6-25.5 1-9 5.5-17 12.5-22.5 7-5.5 16-8.5 25-8 9 .5 17.5 4.5 23.5 11 6 6.5 9 15 8.5 24-.5 9-4.5 17-11.5 23-7 6-16 9.5-25.5 9.5-9.5 0-18.5-3.5-25.5-9.5M128 200c-39.8 0-72-32.2-72-72s32.2-72 72-72 72 32.2 72 72-32.2 72-72 72z"
        fill="#FFFFFF"
      />
    </svg>
  ),
  excel: () => (
    ...
    >
      ...
      <g>
        ...
        />
        <path fill="#27663f" d="M29 15.003H44V24.005000000000003H29z" />
        <path fill="#19ac65" d="M29 24.005H44V33.055H29z" />
        <path
          fill="#129652"
          d="M29,33.054v8.946h13.256C43.219,42,44,41.219,44,40.257v-7.202H29z"
        />
      </g>
      <path
        fill="#0c7238"
  ...
  openai: () => <Building className="text-black" />,
  googleDrive: () => (
    <svg
      width="100"
      height="100"
